...
import org.davide.lamqtt.backend.dto.ILogCallback;
import org.davide.lamqtt.common.MQTTClient;
import org.davide.lamqtt.common.MQTTMessage;
import org.davide.lamqtt.common.MQTTReceiver;
import org.davide.lamqtt.common.MQTTSpatialMessages;
...
public class SpatialMQTTBackEnd extends MQTTClient implements MQTTReceiver, ILogCallback {
    ...
    public SpatialMQTTBackEnd(String username, String password, String host, Integer port) {
        ...
        if (this.persisterType == PersisterType.MEMORY) this.persister = new MemPersister();
        else this.persister = new Persister(SpatialMQTTBackEnd.STORAGE_NAME);
    ...
    public void messageRecv(MQTTMessage msg) {
    ...
    private void handlePositionUpdate(String payload) {
        if (this.verboseMode) {
    ...
    private void handleGeofenceUpdate(String payload) {
        if (this.verboseMode) {
    ...
    private void handleSubscriptionUpdate(String payload) {
        if (this.verboseMode) {
