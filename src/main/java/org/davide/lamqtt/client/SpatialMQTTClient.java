package org.davide.lamqtt.client;

import org.davide.lamqtt.client.privacy.*;
...
public class SpatialMQTTClient extends MQTTClient {
     ...
     */
    public SpatialMQTTClient(String username, String password, String host, int port, String clientId) {
     ...
     */
    public CompletableFuture<Position> publicPosition(double latitude, double longitude) {
