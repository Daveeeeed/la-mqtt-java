...
import org.davide.lamqtt.backend.SpatialMQTTBackEnd;
...
public class Scenario implements MQTTReceiver {
    ...
    public void update(double timeAdvance, double currentTime) throws ExecutionException, InterruptedException {
