...
import org.davide.lamqtt.client.SpatialMQTTClient;
import org.davide.lamqtt.client.privacy.IPrivacyManager;
import org.davide.lamqtt.client.privacy.PrivacyModel;
import org.davide.lamqtt.client.privacy.PrivacySet;
...
public class SimulatedUser implements MQTTReceiver {
    ...
    public void publishPosition(Double ctime) throws ExecutionException, InterruptedException {
...
*/
    ...
    public void move(Double timeAdvance, Double currentTime) throws ExecutionException, InterruptedException {
    ...
    @Override
    public void messageRecv(MQTTMessage message) {
